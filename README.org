...
* Prerequisites
** Docker
[[https://www.docker.com/][Docker]] is a free and opens-source software that automates the deployment and running of containerized applications.
...
You will notice there is a red WiFi icon on the bottom right indicating you are offline. Indeed, the file cannot be shared among other devices, because the WebSocket server hasn't been configured yet. In order to configure it, you go to Administration Settings > Administration (Section) > Whiteboard. There you need to fill in the following information:
